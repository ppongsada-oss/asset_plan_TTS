...
| [04_skills.md](04_skills.md) | All 11 skill SKILL.md templates (file_manager, variable_manager, mece, coder, editor, session_manager, **self_improve**, token_auditor, token_tracker, identity, agent) | When writing skill files |
...
| `.sessions/cycle_N_<section_id>.json` | agent skill — written by each sub-agent after completing its section (must include tokens_estimated) |
| `.sessions/self_improve_log.md` | self_improve skill — SI-N audit entries written after each harness edit |

...
--> statement-breakpoint
CREATE UNIQUE INDEX `planning_cycles_cycle_number_unique` ON `planning_cycles` (`cycle_number`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `planning_jobs_job_number_unique` ON `planning_jobs` (`job_number`);--> statement-breakpoint
